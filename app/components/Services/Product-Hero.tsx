  ...
  return (
    ...
    >
      <div className="size-full bg-black/75 pt-16 md:pt-20 flex flex-col gap-4 md:gap-6 lg:gap-8 justify-center items-center px-4">
        <h2 className="border-[#15522D] bg-[#052E16] text-white border text-xs sm:text-sm tracking-wide rounded-full px-3 md:px-4 py-2 md:py-3 uppercase">
          What We Do
        </h2>
        <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-white text-center">
          Products & Solutions
        </h3>
        <p className="text-center max-w-3xl text-sm sm:text-base md:text-lg lg:text-xl text-neutral-300 px-4">
          {
