    ...
    <div className='absolute top-0 bg-white/5 border-b border-white/10 w-full flex justify-center'>
      <div className='container flex justify-between py-2'>
        ...
        <div className='flex gap-6 items-center'>
          ...
          <Link className='text-white' href={"/about"}>Who we are</Link>
          <Link className='text-white' href={"/services"}>What we do</Link>
          <Link className='text-white' href={"#"}>Resources</Link>
